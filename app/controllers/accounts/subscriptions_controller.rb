...
module Accounts
  ...
  class SubscriptionsController < Accounts::BaseController
    ...
    def show
      return redirect_to new_accounts_subscription_path unless @subscription
    ...
    def require_subscription
      redirect_to accounts_profile_path unless @subscription
    end

    def require_cancelled_subscription
      redirect_to accounts_subscription_path unless @subscription.cancelled?
    end

    def require_active_subscription
      redirect_to accounts_subscription_path unless @subscription.active?
    end
  end
end
