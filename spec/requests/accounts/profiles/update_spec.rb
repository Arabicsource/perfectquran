...
describe '/accounts/profiles/update', type: :request do
  let :valid_params do
    { profile:
  ...
  context 'without account' do
    before { patch accounts_profile_path, params: valid_params }
  ...
  context 'with account' do
    ...
    describe 'when success' do
      ...
      specify { expect(response).to redirect_to accounts_profile_path }
    ...
    describe 'when failure' do
      before { patch accounts_profile_path, params: invalid_params }
